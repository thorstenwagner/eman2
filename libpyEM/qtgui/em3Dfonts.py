...
class EMFontInspector(QWidget, EMLightsInspectorBase):
	...
	def get_format_tab(self):
		...
		formattab.vbl = QVBoxLayout(self.formattab)
		...
		self.hbl1 = QHBoxLayout()
		self.Dfont = QComboBox()
		for k in self.l: self.Dfont.addItem(k)
		self.hbl1.addWidget(QLabel("Fonts:",self))
		...
		self.hbl1.addWidget(QLabel("Size:",self),Qt.AlignLeft)
		...
		self.hbl1.addWidget(QLabel("Style:",self),Qt.AlignLeft)
		...
		self.hbl1 = QHBoxLayout()
		self.cbb = QComboBox()
		self.hbl1.addWidget(QLabel("Material:",self))
		self.hbl1.addWidget(self.cbb)
		formattab.vbl.addLayout(self.hbl1)

		self.hbl1 = QHBoxLayout()
		self.bgtabwidget = QTabWidget()
		self.maintab = None
	...
	def get_bgRGB_tab(self):
		self.bgRGBtab = QWidget()
		bgRGBtab = self.bgRGBtab
		bgRGBtab.vbl2 = QVBoxLayout(self.bgRGBtab)
