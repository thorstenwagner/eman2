...
class EMPlot3DStatsInsp(QWidget):
...
class EMPlot3DRegrInsp(QWidget):
...
class EMPlot3DClassInsp(QWidget):
...
class EMPlot3DInspector(QWidget):
...
#		self.pdfb.setEnabled(False)
		...
		gl.addWidget(QLabel("Z Col:",self),2,0,Qt.AlignRight)
		self.slidez=QSpinBox(self)
...
#		self.wl2.setAlignment(Qt.AlignHCenter)
		...
		hbl5a = QHBoxLayout()
		hbl5a.addWidget(QLabel("Z Label:",self))
		self.zlabel=QLineEdit(self)
