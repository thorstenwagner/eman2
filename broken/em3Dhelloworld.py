...
class EMHelloWorldInspector(QWidget):
	...
	def get_main_tab(self):
		if ( self.maintab == None ):
			...
			self.x_trans = QDoubleSpinBox(self)
			...
			self.y_trans = QDoubleSpinBox(maintab)
			...
			self.z_trans = QDoubleSpinBox(maintab)
